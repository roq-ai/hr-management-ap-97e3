...
import { useMeFindFirst, useRoqClient } from 'lib/roq';
...
function MeViewPage() {
  ...
  const { data, error, isLoading } = useMeFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('me', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/us/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="me" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
