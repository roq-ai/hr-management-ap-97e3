...
export function useMeFindMany<
  T extends Prisma.meFindManyArgs,
  R extends GetFindResult<Prisma.$mePayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.meFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useMeFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.me.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useMeCount<T extends Prisma.meCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.meCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useMeCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.me.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useMeFindManyWithCount<
  T extends Prisma.meFindManyArgs,
  R extends { data: GetFindResult<Prisma.$mePayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.meFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useMeFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.me.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useMeFindFirst<
  T extends Prisma.meFindFirstArgs,
  R extends GetFindResult<Prisma.$mePayload<DefaultArgs>, T>,
>(args?: Prisma.SelectSubset<T, Prisma.meFindFirstArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useMeFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.me.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
